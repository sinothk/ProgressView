package com.sinothk.view.progress.loading1;
...
import com.sinothk.view.progress.R;
...
public class HiveProgressView extends View {
    ...
    private void initAttributes(AttributeSet attrs, int defStyle) {
        ...
        if (a.hasValue(R.styleable.HiveProgressView_hive_color)) {
            color = a.getInt(R.styleable.HiveProgressView_hive_color, Color.BLACK);
        }
